                ...
                children: <Widget>[
                  ...
                  ListTile(
                    ...
                    onTap: () => Navigator.of(context).push(
                        MaterialPageRoute(builder: (_) => const ChangeLanguagePage())),
                  ),
                   ListTile(
                    title: const Text('Change Country'),
                     leading: Image.asset('assets/icons/country.png'),
                    onTap: () => Navigator.of(context).push(
                        MaterialPageRoute(builder: (_) => const ChangeCountryPage())),
                  ),
                   ListTile(
                   ...
                   ListTile(
                    ...
                    onTap: () => Navigator.of(context).push(
                        MaterialPageRoute(builder: (_) => const LegalAboutPage())),
                  ),
                   ListTile(
